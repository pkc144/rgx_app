          ...
          <View style={{flexDirection:'row',marginTop:20,}}>
           ...
           <XIcon size={24} color="#000" />
            ...
            <View style={styles.content}>
              ...
              <Text style={styles.instruction}>
                2. Click on the "Register an App" tab, then fill in the "App Name" field with "{Config?.REACT_APP_WHITE_LABEL_TEXT || 'EquityPro'}" or a name of
...
them into the {Config?.REACT_APP_WHITE_LABEL_TEXT || 'EquityPro'} platform to connect
your broker.
              </Text>
            </View>
            </View>
  ...
  <>
    ...
    >
      <View style={{ paddingHorizontal: 16, paddingTop: 10 }}>
        ...
        <Text style={styles.instruction1}>
          (ii) Create an Application: Navigate to the "Applications" section, click on "Add New Application," and fill required details (use any app name, e.g., {Config?.REACT_APP_WHITE_LABEL_TEXT || 'EquityPro'}). Select Unlimited in Shared Quota, leave description & group empty, then save.
        </Text>
...
field with "{Config?.REACT_APP_WHITE_LABEL_TEXT || 'EquityPro'}" or a name of your choice.
      ...
      <View style={{ flex: 0 }}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.instruction}>
            ...
            Enter a name for your app (e.g., {Config?.REACT_APP_WHITE_LABEL_TEXT || 'EquityPro'}) and enter the Redirect URL below:
          </Text>
